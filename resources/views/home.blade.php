...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        likeButton.addEventListener('click', () => {
            ...
            fetch(`/videos/${videos[currentIndex].id}/${isLiked ? 'dislike' : 'like'}`, {
                method: 'POST',
                ...
                .then(data => {
                    Swal.fire({
                        ...
                        // Update the UI
                        likeButton.textContent = isLiked ? 'Like' : 'Dislike'; // Toggle button text
